...
<xsl:import href="lucene/_search-results-html.xsl"/>

<!-- By convention, we organise by [group]/[service].xsl -->
<xsl:import href="lucene/search.xsl"/>
<xsl:import href="lucene/browse.xsl"/>
<xsl:import href="lucene/autosuggest.xsl"/>
