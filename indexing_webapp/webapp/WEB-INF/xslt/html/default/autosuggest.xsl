...
<xsl:template match="content[@name='autosuggest']" mode="content">
  ...
  <div class="row">
    ...
    <div class="small-4 columns end">
      <input type="text" class="autosuggest" name="term" data-href="/autosuggest/words.xml" />
    </div>
  </div>
  <div class="row">
    <div class="small-2 columns text-right">People</div>
    <div class="small-4 columns end">
      <input type="text" class="autosuggest" name="term" data-href="/autosuggest/people.xml" />
    </div>
  </div>
  <div class="row">
    <div class="small-2 columns text-right">Movies</div>
    <div class="small-4 columns end">
      <input type="text" class="autosuggest movies" name="term" data-href="/autosuggest/movies.xml" />
    </div>
  </div>
  <div class="row">
    <div class="small-2 columns text-right">Movies<br/><small>with extra weight to USA</small></div>
    <div class="small-4 columns end">
      <input type="text" class="autosuggest movies" name="term" data-href="/autosuggest/usmovies.xml" />
    </div>
  </div>
</xsl:template>
